...
#define MODEL_NAME_1_X              (TEXT_START)
#define MODEL_NAME_1_Y              (60)

#define PRE_TIME_STR_X              (TEXT_START)
#define PRE_TIME_STR_Y              (110)
#define I_TIME_STR_X                (TEXT_START)
#define I_TIME_STR_Y                (160)
#define P_TIME_STR_X                (TEXT_START)
#define P_TIME_STR_Y                (210)

#define MODEL_NAME_2_X              (TEXT_START)
#define MODEL_NAME_2_Y              (310)

#define PRE_TIME_STR_X_FACE         (TEXT_START)
#define PRE_TIME_STR_Y_FACE         (360)
#define I_TIME_STR_X_FACE           (TEXT_START)
#define I_TIME_STR_Y_FACE           (410)
#define P_TIME_STR_X_FACE           (TEXT_START)
#define P_TIME_STR_Y_FACE           (450)

#define FPS_STR_X                   (TEXT_START)
#define FPS_STR_Y                   (510)
